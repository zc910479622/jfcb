...
<div id="navbar" class="navbar navbar-default navbar-collapse collapse">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <span class="navbar-brand" style="font-size: 1.8em;font-family: '楷体';">摩轮成本管理平台</span>
        </div>
        <ul class="nav navbar-nav">
            ...
            <li class=" <% if (request.getParameter("aItem").equals("2")) {%> active <%} %>"><a
                    href="planQuery.jsp"><span class="glyphicon glyphicon-object-align-left"></span> 成本管理</a></li>
            <li class=" <% if (request.getParameter("aItem").equals("3")) {%> active <%} %>"><a
                    href="staffTable.jsp"><span class="glyphicon glyphicon-object-align-left"></span> 物料信息</a></li>
        </ul>
    </div>
</div>
